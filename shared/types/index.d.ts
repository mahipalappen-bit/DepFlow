...
export type NotificationType = 'dependency_update' | 'vulnerability_alert' | 'update_request' | 'request_approved' | 'request_rejected' | 'team_assignment' | 'system_alert';
...
export type ActivityType = 'dependency_added' | 'dependency_updated' | 'dependency_removed' | 'vulnerability_detected' | 'update_requested' | 'request_approved' | 'request_completed';
